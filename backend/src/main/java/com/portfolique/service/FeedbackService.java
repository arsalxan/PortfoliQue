...
public class FeedbackService {
    ...
    public Page<FeedbackResponse> getFeedbacksForPortfolio(Long portfolioId, Pageable pageable) {
        ...
        return feedbackRepository.findByPortfolioOrderByCreatedAtDesc(portfolio, pageable)
    ...
    public void deleteFeedback(Long feedbackId, User currentUser) {
        ...
        if (!isAuthor && !isPortfolioOwner) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Not authorized to delete this feedback");
        }
