...
public class PortfolioService {
  ...
  public PortfolioService(
      PortfolioRepository portfolioRepository, CloudinaryService cloudinaryService) {
  ...
  public PortfolioResponse updatePortfolio(
    ...
    if (!portfolio.getUser().getId().equals(currentUser.getId())) {
      throw new ResponseStatusException(
          HttpStatus.FORBIDDEN, "You do not have permission to edit this portfolio");
    }
  ...
  public void deletePortfolio(Long id, User currentUser) {
    ...
    if (!portfolio.getUser().getId().equals(currentUser.getId())) {
      throw new ResponseStatusException(
          HttpStatus.FORBIDDEN, "You do not have permission to delete this portfolio");
    }
  ...
  public Page<PortfolioResponse> searchPortfolios(String query, Pageable pageable) {
    ...
    return portfolioRepository
        .searchByDescriptionOrUsername(query, pageable)
        .map(this::mapToResponse);
  }
