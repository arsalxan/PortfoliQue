...
public interface FeedbackRepository extends JpaRepository<Feedback, Long> {
    ...
    @Query("SELECT f FROM Feedback f JOIN f.user u WHERE " +
    ...
    Page<Feedback> searchByFilters(@Param("username") String username, @Param("content") String content, Pageable pageable);
}
