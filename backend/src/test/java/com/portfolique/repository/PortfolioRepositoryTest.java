...
public class PortfolioRepositoryTest {
  ...
  public void testSaveAndSearchPortfolio() {
    ...
    Page<Portfolio> results =
        portfolioRepository.searchByDescriptionOrUsername("java", PageRequest.of(0, 10));
  ...
  public void testSearchByDescriptionOrUsername() {
    ...
    Page<Portfolio> res1 =
        portfolioRepository.searchByDescriptionOrUsername("BOOT", PageRequest.of(0, 10));
    assertThat(res1.getContent()).hasSize(1);

    // Search by username
    Page<Portfolio> res2 =
        portfolioRepository.searchByDescriptionOrUsername("spring_pro", PageRequest.of(0, 10));
