...
public class PortfolioServiceTest {
  ...
  void setUp() {
    ...
    testPortfolio = Portfolio.builder().id(1L).url("http://test.com").user(testUser).build();
  }
  ...
  void testCreatePortfolio() throws IOException {
    ...
    MockMultipartFile file =
        new MockMultipartFile("screenshot", "test.png", "image/png", "content".getBytes());

    when(cloudinaryService.uploadPortfolioScreenshot(any()))
        .thenReturn("http://cloudinary.com/img.png");
